  ...
  return (
    <div className="flex min-h-screen overflow-x-hidden">
      ...
      <div className="flex-1 flex flex-col">
        ...
        {/* ===== HERO SECTION with its own gradient ===== */}
            ...
            {user ? (
              ...
              <>
                <h1 className="font-display text-4xl md:text-5xl tracking-wide mb-6 text-gray-800 dark:text-slate-200">
                  From raw data to <span className="text-neonBlue font-semibold">smart decisions</span><br/>
        ...
        {/* ===== REST OF PAGE - plain white background ===== */}
        <main className="flex-1 bg-white dark:bg-slate-900 relative z-10 px-8 py-12">

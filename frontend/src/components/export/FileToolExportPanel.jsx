...
export default function FileToolExportPanel({ 
  ...
  const [position, setPosition] = useState({ x: 20, y: window.innerHeight * 0.35 });
  ...
  return (
    ...
    >
      <div className="rounded-xl bg-white border-2 border-neonBlue/20 shadow-2xl dark:bg-slate-800/95 dark:border-neonBlue/30 backdrop-blur-sm neon-border">
        {/* Draggable Header */}
        <div className="drag-handle p-3 border-b border-gray-200 dark:border-white/10 cursor-move bg-gradient-to-r from-neonBlue/5 to-indigo-500/5 rounded-t-xl">

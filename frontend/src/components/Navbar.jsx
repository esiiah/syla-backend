// frontend/src/components/Navbar.jsx - FIXED CLOSING TAGS
    ...
    <>
      ...
      {showSidebar && (
        <>
          ...
          {/* Sidebar */}
          <div className="fixed top-0 left-0 h-full w-64 bg-white dark:bg-slate-900 z-50 md:hidden shadow-xl transform transition-transform duration-300">
            <Sidebar 
              onReportChange={() => {}} 
              theme={theme} 
              setTheme={setTheme}

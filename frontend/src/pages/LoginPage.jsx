      ...
      <div className="w-full max-w-md bg-white dark:bg-ink/90 rounded-t-3xl rounded-b-lg shadow-2xl border-2 border-neonBlue dark:border-neonYellow p-8 mt-16 sm:mt-0">
        ...
        {!showDetails ? (
          <div className="space-y-4">
            ...
            <button onClick={handlePhoneLogin} className="w-full px-4 py-3 border-2 border-neonBlue/30 rounded-lg hover:border-neonBlue/60 transition-all duration-200 bg-blue-50 dark:bg-slate-800">Continue with Phone</button>

            <div className="mt-6 text-center text-sm text-gray-600 dark:text-slate-400">
              Don't have an account? <Link to="/signup" className="text-neonBlue dark:text-neonYellow font-semibold hover:underline">Create one here</Link>
            </div>
          </div>
        ) : (
          <div>
